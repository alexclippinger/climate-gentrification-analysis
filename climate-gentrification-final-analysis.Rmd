...
## Twitter Data
```{r}
raw_tweets <- readxl::read_excel(here("data","twitter_data_agg.xlsx"),skip=6)
...
### Create corpus of tweets and cleaning using `quanteda`
```{r create_corpus}
...
### Initial exploration of cleaned corpus
...
#### Add Bing sentiments and clean tokens
```{r}
...
#### Get NRC fear sentiments and add clean tokens
```{r}
...
#### Word relationships / Correlations of words
```{r tidy}
...
# find words that occur close together in the nexis uni pdfs
...
cg_tweets <- search_tweets(q = "#climategentrification",
                               n = 100)
