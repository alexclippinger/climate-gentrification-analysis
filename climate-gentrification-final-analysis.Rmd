...
The following plot displays the intertopic distance map for k=5
...
The topic circles indicate which topics have more words in common by their relative distance.
An interesting result from this plot is that topic 4 (Miami) has the most in common with Topics 2 and 3, which focus on impacted communities and people.
This reflects the grassroots efforts to raise awareness of climate gentrification in Miami neighborhoods that we have discussed.
